<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
        <form action="{{ route('conductores.update', $conductor->id) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="nombre_apellido" name="nombre_apellido" value="{{ old('nombre_apellido', $conductor->nombre_apellido) }}"
            ...
            <div>
                ...
                <input type="text" id="dni_conductor" name="dni_conductor" value="{{ old('dni_conductor', $conductor->dni_conductor) }}" required
            ...
            <div>
                ...
                <input type="text" id="domicilio" name="domicilio" value="{{ old('domicilio', $conductor->domicilio) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
            </div>
            ...
            <div>
                ...
                <input type="text" id="categoria_carnet" name="categoria_carnet" value="{{ old('categoria_carnet', $conductor->categoria_carnet) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
            </div>
            ...
            <div>
                ...
                <input type="text" id="tipo_conductor" name="tipo_conductor" value="{{ old('tipo_conductor', $conductor->tipo_conductor) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
            </div>
            ...
            <div>
                ...
                <input type="text" id="destino" name="destino" value="{{ old('destino', $conductor->destino) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
            </div>
